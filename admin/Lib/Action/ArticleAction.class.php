...
class ArticleAction extends CommonAction{
	...
	public function add()
	{
		...
		if(OPEN_WEIXIN)
		{
			...
			{
			$config_file =  APP_ROOT_PATH."system/web_cfg/".APP_TYPE."/wxwebnav_cfg.php";
			$jump_url = array_merge_web_nav($jump_url, $config_file);
			}
		}
		if(defined("FX_LEVEL"))
		{
			$config_file =  APP_ROOT_PATH."system/web_cfg/".APP_TYPE."/fxwebnav_cfg.php";
			$jump_url = array_merge_web_nav($jump_url, $config_file);
		}
		if(defined("DC"))
		{
			$config_file =  APP_ROOT_PATH."system/web_cfg/".APP_TYPE."/dcwebnav_cfg.php";
			$jump_url = array_merge_web_nav($jump_url, $config_file);
		}
	...
	public function insert() {
		...
		if($data['u_module']!='')
		{
			...
			if(OPEN_WEIXIN)
			{
				...
				{
				$config_file =  APP_ROOT_PATH."system/web_cfg/".APP_TYPE."/wxwebnav_cfg.php";
				$navs = array_merge_web_nav($navs, $config_file);
				}
			}
			if(defined("FX_LEVEL"))
			{
