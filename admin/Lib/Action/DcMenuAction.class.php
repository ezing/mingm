...
class DcMenuAction extends CommonAction{
	public function index()
	{
		...
		if($supplier_location_id)
		{
			$supplier_location_info = M("SupplierLocation")->where('id='.$supplier_location_id)->find();
	...
	public function insert() {
		...
		$name_info=M(MODULE_NAME)->where("name = '".$data['name']."' and location_id =".$location_id)->findAll();
	...
	public function update() {
		...
		$name_info=M(MODULE_NAME)->where("name = '".$data['name']."' and location_id =".$location_id.' and id != '.$data['id'])->findAll();
