...
class KtvRoomTypeAction extends CommonAction{
...
//		$list=M(MODULE_NAME)->add($data);
		$sql ="INSERT INTO `".DB_PREFIX."ktv_room_type`( `name`, `demo`) VALUES ('$name','$demo')" ;
...
//		file_put_contents('1.txt',var_dump($fields,true));//不能打印，所以写到文本里
//		$list=M(MODULE_NAME)->add($data);
		$sql ="UPDATE `".DB_PREFIX."ktv_room_type` set `name`= '$name', `demo`= '$demo' where `id` = $id ";
