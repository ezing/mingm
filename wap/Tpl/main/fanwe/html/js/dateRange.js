function pickerDateRange(inputId, options) {
	...
	var wrapper = {
		...
		ta: [
			...
			'<input type="text" class="ta_ipt_text_s star" name="' + this.startDateId + '" id="' + this.startDateId + '" value="' + this.mOpts.startDate + '" readonly />',
			'<span class="' + this.mOpts.joinLineId + '"> - </span>',
			'<input type="text" class="ta_ipt_text_s end" name="' + this.endDateId + '" id="' + this.endDateId + '" value="' + this.mOpts.endDate + '" readonly /><br />',
			'</div>',
