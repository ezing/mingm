...
class dc_biz_resorderModule extends MainBaseModule
{
	...
	{	
		...
		$data = call_api_core("dc_biz_resorder","index",$param);
	...
	public function order()
	{
		...
		$data = call_api_core("dc_biz_resorder","order",$param);
	...
	{	
		...
		$data = call_api_core("dc_biz_resorder","accept_order",$param);
	...
	public function close_order()
	{
		...
		$data = call_api_core("dc_biz_resorder","close_order",$param);
