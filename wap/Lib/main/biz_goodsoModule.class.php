...
class biz_goodsoModule extends MainBaseModule
{
	...
	public function index(){
	    ...
	    $data = call_api_core("biz_goodso","index",$param);
    ...
    public function goodss(){
        ...
        $data = call_api_core("biz_goodso","goodss",$param);
    ...
    public function delivery_form(){
        ...
        $data = call_api_core("biz_goodso","delivery_form",$param);
    ...
    public function do_delivery(){
        ...
        $data = call_api_core("biz_goodso","do_delivery",$param);
