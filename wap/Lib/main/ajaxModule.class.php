...
class ajaxModule extends MainBaseModule
{
	...
	public function count_buy_total()
	{
		...
		$data = call_api_core("cart","count_buy_total",array("delivery_id"=>$delivery_id,"ecvsn"=>$ecvsn,"ecvpassword"=>$ecvpassword,"payment"=>$payment,"all_account_money"=>$all_account_money));
