...
class Dc_Upacp_payment implements payment {
	...
	public function get_payment_code($payment_notice_id)
	{
		...
		$data_return_url = SITE_DOMAIN.APP_ROOT.'/index.php?ctl=dc_payment&act=response&class_name=Upacp';
		$data_notify_url = SITE_DOMAIN.APP_ROOT.'/index.php?ctl=dc_payment&act=notify&class_name=Upacp';
