...
class Dc_Upacpwap_payment implements payment {
	...
	public function get_payment_code($payment_notice_id)
	{
		...
		$pay['pay_action'] = SITE_DOMAIN.APP_ROOT."/cgi/dc_payment/upacpwap/redirect.php?notice_id=".$payment_notice_id."&from=".$GLOBALS['request']['from'];
	...
	public function get_redirect_url($payment_notice_id)
	{
		...
		if($from=="wap")
		  	$data_return_url = SITE_DOMAIN.APP_ROOT.'/callback/dc_payment/upacpwap_response.php';
		else
			$data_return_url = SITE_DOMAIN.APP_ROOT.'/callback/dc_payment/upacpwap_response_app.php';
		
		$data_notify_url = SITE_DOMAIN.APP_ROOT.'/callback/dc_payment/upacpwap_notify.php';
