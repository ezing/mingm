...
class Dc_Yjwap_payment implements payment {
	...
	public function get_payment_code($payment_notice_id)
	{
		...
		require_once(APP_ROOT_PATH.'system/dc_payment/yeepay/yeepayMPay.php');
		...
		if($from=="wap")
			$data_return_url = SITE_DOMAIN.APP_ROOT.'/callback/dc_payment/yjwap_response.php';
		else
			$data_return_url = SITE_DOMAIN.APP_ROOT.'/callback/dc_payment/yjwap_response_app.php';
		
		$data_notify_url = SITE_DOMAIN.APP_ROOT.'/callback/dc_payment/yjwap_notify.php';
	...
	public function response($request)
	{
		...
		//file_put_contents(APP_ROOT_PATH."system/dc_payment/log/yjwap_response_".strftime("%Y%m%d%H%M%S",time()).".txt",print_r($request,true));
