		...
		"goods_tuangou"	=>	array(
				...
				"groups"	=>	array(
						...
						"goods_tuangou"	=>	array(
								...
								"key"	=>	"goods_tuangou",
								"nodes"	=>	array(
										array("name"=>"拼团列表","module"=>"PinTuan","action"=>"index"),
								),
						),
						"kanjia"	=>	array(
								"name"	=>	"砍价",
								"key"	=>	"kanjia",
								"nodes"	=>	array(
										array("name"=>"砍价列表","module"=>"KanJia","action"=>"index"),
	...
	"deal"	=>	array(
		...
		"groups"	=>	array( 			
			...
			"hotel"	=>	array(
				...
				"key"	=>	"hotel",
				"nodes"	=>	array(
						array("name"=>"酒店属性","module"=>"HotelShuxing","action"=>"index"),
						array("name"=>"酒店服务","module"=>"HotelFuwu","action"=>"index"),
			...
			"ktv"	=>	array(
					...
					"key"	=>	"ktv",
					"nodes"	=>	array(
							//array("name"=>"房间类型","module"=>"KtvRoomType","action"=>"index"),
							array("name"=>"购买属性","module"=>"KtvShuxing","action"=>"index"),
					),
			),
		),
	),
			...
			"groups"	=>	array(
                    ...
                    "storepayorder"	=>	array(
    					...
    					"nodes"	=>	array(
    					    ...
    					    array("name"=>"收款单列表","module"=>"PaymentNotice","action"=>"store_pay_index"),
					   ),
					),	
