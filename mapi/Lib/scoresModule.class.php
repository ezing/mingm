...
class scoresApiModule extends MainBaseApiModule
{
	...
	public function index()
	{
		...
		$deal_score=strim($GLOBALS['request']['deal_score']);
		...
		elseif ($order_type=='deal_asc') //积分升
			$order= " d.return_score desc  ";
		elseif ($order_type=='deal_desc')//积分降
			$order= " d.return_score asc  ";
