...
$(function(){
	...
	$.ajax({
		url:url,
		type:"POST",
		data:{'xpoint':dataset.lng,'ypoint':dataset.lat,'dc_title':dataset.title,'dc_content':dataset.content,'dc_num':dataset.dc_num,'city':dataset.city},
						...
						$.ajax({
							...
							success:function(objdata)
							{
								...
								$.ajax({
									...
									type:"POST",
									dataType:"json",
									data:{'xpoint':item.location.lng,'ypoint':item.location.lat,'dc_title':item.name,'dc_content':item.address,'dc_num':objdata.dc_num,'city':city},
									success:function(obj){
