...
require APP_ROOT_PATH.'app/Lib/hiz/core/HizBaseModule.class.php';
require APP_ROOT_PATH.'app/Lib/hiz/core/hiz_init.php';
define("CTL",'ctl');
define("ACT",'act');
...
class HizApp{		
	...
	public function __construct(){
		...
		if(!file_exists(APP_ROOT_PATH."app/Lib/hiz/".$module."Module.class.php"))
		$module = "index";
		
		require_once APP_ROOT_PATH."app/Lib/hiz/".$module."Module.class.php";				
