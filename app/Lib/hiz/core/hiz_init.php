...
require_once APP_ROOT_PATH.'app/Lib/hiz/core/hiz_lib.php';
$IMG_APP_ROOT = APP_ROOT;
define("APP_INDEX","hiz");
...
if(!file_exists(APP_ROOT_PATH.'public/runtime/app/tpl_caches/hiz/'))
	mkdir(APP_ROOT_PATH.'public/runtime/app/tpl_caches/hiz/',0777);
if(!file_exists(APP_ROOT_PATH.'public/runtime/app/tpl_compiled/hiz/'))
	mkdir(APP_ROOT_PATH.'public/runtime/app/tpl_compiled/hiz/',0777);
$GLOBALS['tmpl']->cache_dir      = APP_ROOT_PATH . 'public/runtime/app/tpl_caches/hiz';
$GLOBALS['tmpl']->compile_dir    = APP_ROOT_PATH . 'public/runtime/app/tpl_compiled/hiz';
$GLOBALS['tmpl']->template_dir   = APP_ROOT_PATH . 'app/Tpl/hiz';

//定义模板路径
$tmpl_path = SITE_DOMAIN.APP_ROOT."/app/Tpl/";
$GLOBALS['tmpl']->assign("TMPL",$tmpl_path."hiz");
$GLOBALS['tmpl']->assign("TMPL_REAL",APP_ROOT_PATH."app/Tpl/hiz"); 
